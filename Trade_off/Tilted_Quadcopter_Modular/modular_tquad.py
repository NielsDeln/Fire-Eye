...
def m_motor(T_max): # Maximum Thrust of Motor [gr]
    return (1e-07 * T_max**3 - 0.0003 * T_max**2 + 0.2783 * T_max - 56.133) # g # kept from quadcopter, for first iteration
...
if __name__ == "__main__":
    ...
    for margin in margin_factors:
        ...
        try:
            ...
            performance = analyze_performance(results, tilt_angle=30)
