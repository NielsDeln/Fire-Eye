...
def converge_gtow_and_prop_octo(m_pl, battery_capacity=None, n_cells=None, tol=1e-2, max_iter=10, battery_override=None, n_batteries=None):
    ...
    gtow, T_max, T_motor, m_m, m_e, m_b, m_p, m_f, m_a, m_pl = converge_gtow_octo(m_pl, d_p=d_p, n_batteries=n_batteries, battery_override=battery_override, motor_override=motor)
