battery_dbx = [
    ...
    #{'id': 'GAONENG GNB LiHV 6S', 'type': 'LiPo', 'cells': 6, 'capacity': 1100, 'mass': 177, 'voltage': 22.8, 
     #'energy_capacity': 25.08, 'C-rating': 120, 'energy_density': 141.69},
...
motor_db =  [
    ...
    {
        'id': 'Turnigy 2836 Brushless Outrunner 1000kv',
        'mass': 80.0,
        'kv_rating': 1000,
        'voltage': 11.65,
        'max_thrust': 1100.0,
